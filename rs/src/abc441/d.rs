fn main() {
    ...
    let g = Graph::from_edges_directed(n, uvc);

    let verts = iterate(vec![(0, 0)], |verts| {
        verts
            .iter()
            .copied()
            .flat_map(|(v, d)| {
...
use std::{
    ...
    iter::{from_fn, once, once_with, repeat, repeat_n, repeat_with, successors},
