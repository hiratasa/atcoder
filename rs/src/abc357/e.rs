fn main() {
    ...
    let g = Graph::from_edges_directed(n, a.into_iter().enumerate());

    let mut t = vec![(n, 0); n];
    let mut visited = vec![false; n];
    let mut visiting = vec![false; n];
    for i in 0..n {
        calc(&g, i, &mut visiting, &mut visited, &mut t);
    }
...
fn calc(
    ...
    let (s, c) = calc(g, u, visiting, visited, t);
